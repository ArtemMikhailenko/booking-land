...
export const FeatureList: React.FC<FeatureListProps> = ({ features }) => {
  return (
    <div className="space-y-4">
      <h3 className="text-[20px] sm:text-2xl font-bold text-[#344054] mb-[16px] sm:mb-4 font-geologica" style={{ fontFamily: "'Geologica', sans-serif" }}>
        Тепер ви — в онлайні.
      </h3>
      <div className="space-y-4">
        {features.map((feature) => (
          <div key={feature.id} className="flex gap-3">
            {/* Purple bullet point */}
            <div className="w-[16px] h-[16px] sm:w-5 sm:h-5 bg-[#9270cb] rounded-full mt-0.5 flex-shrink-0"></div>
