...
export const HeroSection: React.FC = () => {
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      <div className="max-w-[1200px] mx-auto px-4 py-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between min-h-screen relative">
          {/* Left content */}
          <div className="flex-shrink-0 space-y-6 relative z-20">
            <div className="space-y-6">
              ...
              <p className="text-[20px] text-[#667085] max-w-xs leading-relaxed">
          ...
          {/* Right content */}
          <div className="flex-shrink-0 space-y-6 relative z-20 text-right">
